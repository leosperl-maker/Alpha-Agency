  ...
  return (
    <div className="p-6 bg-[#F8F8F8] min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#1A1A1A]">Sauvegardes</h1>
          <p className="text-[#666666]">Gestion des sauvegardes automatiques de la base de données</p>
        </div>
        <Button 
        ...
        <Card className="bg-white border-[#E5E5E5]">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-[#666666]">Système</p>
        ...
        <Card className="bg-white border-[#E5E5E5]">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-[#666666]">Dropbox</p>
                <p className="font-bold text-[#1A1A1A]">
        ...
        <Card className="bg-white border-[#E5E5E5]">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-[#666666]">Total backups</p>
                <p className="font-bold text-[#1A1A1A]">{status?.total_backups || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-[#F8F8F8] rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#1A1A1A]">Fréquence</span>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-[#F8F8F8] rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#1A1A1A]">Destinataire</span>
              </div>
              <span className="text-[#666666] text-sm">{status?.email_recipient || "Non configuré"}</span>
            </div>
            
            <div className="flex justify-between items-center p-3 bg-[#F8F8F8] rounded-lg">
              <div className="flex items-center gap-3">
                <History className="w-5 h-5 text-[#666666]" />
                <span className="text-[#1A1A1A]">Rétention</span>
              </div>
            ...
            {status?.scheduler?.next_run && (
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#1A1A1A]">Prochain backup</span>
                </div>
            ...
            {status?.last_backup ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-[#1A1A1A]">{formatDate(status.last_backup.started_at)}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#666666]">Statut</span>
                  <Badge className={
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#666666]">Taille</span>
                  <span className="font-medium text-[#1A1A1A]">{formatSize(status.last_backup.file_size)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#666666]">Dropbox</span>
      ...
      <Card className="bg-white border-[#E5E5E5]">
        ...
        <CardContent>
          {history.length === 0 ? (
            <p className="text-center text-[#666666] py-8">Aucun historique disponible</p>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="text-left border-b border-[#E5E5E5]">
                    <th className="pb-3 text-[#666666] font-medium">Date</th>
                    <th className="pb-3 text-[#666666] font-medium">Type</th>
                    <th className="pb-3 text-[#666666] font-medium">Statut</th>
                    <th className="pb-3 text-[#666666] font-medium">Taille</th>
                    <th className="pb-3 text-[#666666] font-medium">Dropbox</th>
                    <th className="pb-3 text-[#666666] font-medium">Email</th>
                  </tr>
                </thead>
                <tbody>
                  {history.map((backup, index) => (
                    <tr key={backup.backup_id || index} className="border-b border-[#E5E5E5] last:border-0">
                      <td className="py-3 text-[#1A1A1A]">{formatDate(backup.started_at)}</td>
                      <td className="py-3">
                      ...
                      <td className="py-3 text-[#666666]">{formatSize(backup.file_size)}</td>
                      <td className="py-3">
