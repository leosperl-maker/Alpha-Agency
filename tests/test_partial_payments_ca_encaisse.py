...
API_URL: https://ai-crm-assistant-2.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ai-crm-assistant-2.preview.emergentagent.com')
